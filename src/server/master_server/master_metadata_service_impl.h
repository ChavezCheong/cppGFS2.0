    ...
    namespace service
    {
        ...
        public:
            MasterMetadataServiceImpl(common::ConfigManager *config_manager,
                                      bool resolve_hostname = false) : config_manager_(config_manager), resolve_hostname_(resolve_hostname) {}
            ...
            // Generate lease metadata to make leases deterministic. Leader will call this and append to log.
            google::protobuf::util::StatusOr<std::pair<protos::ChunkServerLocation, uint64_t>> GetPreLeaseMetadata(
